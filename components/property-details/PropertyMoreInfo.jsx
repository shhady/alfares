...
export default function PropertyMoreInfo({data}) {
  return (
    <div  className='p-2 pb-8 shadow-2xl flex flex-col gap-2 mt-4'>
        ...
        {data.description && <><div className='font-bold mt-2'>وصف العقار</div>
        ...
        {data.paymentPlan && <><div className='font-bold mt-2'> طريقة الدفع</div>
        <div>{data.paymentPlan}</div></>}
        {data.strengths && <>  <div className='font-bold mt-2'>نقاط قوة المشروع</div>
