...
export default async function Hero() {
  ...
  return (
    <div className='hero-height flex flex-col lg:flex lg:flex-row bg-white'>
      <div className={`lg:w-full lg:flex flex-col justify-center items-center h-full ${styles.animatedBackground}`}>
        <div className={`bg-black bg-opacity-40 p-4 w-full h-full flex flex-col justify-center items-center gap-8 text-center ${styles.content}`}>
